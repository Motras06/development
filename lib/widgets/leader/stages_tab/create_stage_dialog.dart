...
class CreateStageDialog {
  static Future<void> show(BuildContext context, {required String projectId}) async {
            ...
            child: Column(
              ...
              children: [
                ...
                if (isMaterial) ...[
                  ...
                  const SizedBox(height: 8),
                  TextField(controller: unitCtrl, decoration: const InputDecoration(labelText: 'Единица измерения')),
                ],
              ],
            ),
          ),
          ...
          builder: (context, setDialogState) => Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Ресурсы
                Text('Ресурсы', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                            ...
                            try {
                              ...
                              if (context.mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Этап создан!')),
                                );
                              }
                            } catch (e) {
                              if (context.mounted) {
                    ...
                    child: const Text('Создать этап', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
